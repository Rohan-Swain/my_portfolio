...
function ContactLogo() {
  useEffect(() => {
    setTimeout(
      () => document.querySelector(".messageBox1").classList.add("dropShadow"),
      3000
    );

    setTimeout(
      () => document.querySelector(".messageBox2").classList.add("dropShadow"),
      6400
    );
  }, []);
      ...
      >
        <g id="layer1" transform="translate(-68.5,-60)">
          <g id="first-message-box">
            <path
              className="whiteStroke messageBox1"
          ...
          <g id="second-message-box">
            <path
              className="whiteStroke messageBox2"
